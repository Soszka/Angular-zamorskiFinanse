  ...
  oferts: Ofert[] = [
    {
      ...
      description: 'Zabezpiecz swoją przyszłość. Oferuje ubezpieczenia na życie dostosowane do Twoich potrzeb, zapewniające spokój i bezpieczeństwo',
      image: '../../assets/OfertsPhoto1.jpg',
      imageSm: '../../assets/OfertsPhoto11.jpg',
      isActive: false,   },
    {
      title: 'Ubezpieczenie zdrowotne',
      description: 'Dla Ciebie i Twojego zdrowia. Znajdziemy ubezpieczenie dopasowane do Twoich potrzeb, dbając o Twój komfort i bezpieczeństwo',
    ...
    },
    {
      ...
      description: 'Twój kapitał, Twój rozwój. Oferujemy spersonalizowane inwestycje, dostosowane do Twoich celów finansowych i planów na przyszłość',
    ...
    },
    {
      ...
      description: 'Oszczędzaj mądrze, my pomożemy. Znajdziemy dla Ciebie program oszczędnościowy, który wspiera Twoje cele finansowe',
    ...
    },
    {
      ...
      description: 'Bezpieczna podróż z nami. Oferuje ubezpieczenia komunikacyjne, zapewniające kompleksową ochronę dla Ciebie i Twojego pojazdu',
    ...
    {
      title: 'Kredyty',
      description: 'Oferuje elastyczne kredyty, dostosowane do Twoich potrzeb i planów, abyś mógł osiągnąć zamierzone cele',
    ...
    {
      title: 'Leasing',
      description: 'Rozwijaj się z nami. Oferuje elastyczne opcje leasingu, dostosowane do Twoich potrzeb , wspierając rozwój Twojej działalności',
    ...
    },
    {
      ...
      description: 'Twoja firma, moje rozwiązania. Oferuje kompleksową ofertę dla firm, dostosowaną do indywidualnych potrzeb i celów biznesowych',
